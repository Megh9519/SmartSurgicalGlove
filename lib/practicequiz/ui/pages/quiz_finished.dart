...
import 'package:smart_gloves_demonstration_app/practicequiz/ui/pages/check_answers.dart';

class QuizFinishedPage extends StatelessWidget {                                // Creating a stateless widget that returns values from data input //
